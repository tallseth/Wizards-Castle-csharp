    ...
    internal class EnterRoomSituation : ISituation
    {
        ...
        public ISituation PlayThrough(GameData data, GameTools tools)
        {
            ...
            switch (roomInfo.Substring(0,1))
            {
                ...
                case MapCodes.Warp:
                    return tools.SituationBuilder.WarpRoom(roomInfo == MapCodes.WarpOfZot);
                ...
                case MapCodes.Chest:
                    return tools.SituationBuilder.YesOrNo(Messages.FoundChest, tools.SituationBuilder.OpenChest());
                case MapCodes.Pool:
                    return tools.SituationBuilder.YesOrNo(Messages.FoundPool, tools.SituationBuilder.DrinkFromPool());
            }
